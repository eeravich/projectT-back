 ...
 */
/*
create schema projectT;

CREATE TABLE projectT.account(
...
CREATE TABLE projectT.attachment(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   created_datetime TIMESTAMP NOT NULL,
   deleted_datetime TIMESTAMP,
   name TEXT,
...
CREATE TABLE projectT.component(
   id BIGSERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE projectT.discount(
   id BIGSERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE projectT.feedback(
   id BIGSERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE projectT.order_status(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   name TEXT
);

CREATE TABLE projectT.product(
   id BIGSERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE projectT.product_type(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   name TEXT
);

CREATE TABLE projectT.ref_combo_discount(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   combo_id BIGINT,
   discount_id BIGINT,
...
CREATE TABLE projectT.ref_combo_product(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   combo_id BIGINT,
   product_id BIGINT,
...
CREATE TABLE projectT.ref_order_product(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   order_id BIGINT,
   product_id BIGINT,
   count INTEGER,
...
CREATE TABLE projectT.ref_product_component(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   product_id BIGINT,
   component_id BIGINT,
   is_actual BOOLEAN NOT NULL DEFAULT FALSE
...
CREATE TABLE projectT.ref_product_discount(
   id BIGSERIAL NOT NULL PRIMARY KEY,
   product_id BIGINT,
   discount_id BIGINT,
   is_actual BOOLEAN NOT NULL DEFAULT FALSE
...
/**
  Insert TEST dynamic application data
 */
-- Components
/*
